...
export type CreateUserMutation = {
  ...
  createUser?:
    | {
        ...
        user?: { __typename?: 'User'; id: number; username: string; uuid: string; email: string } | null | undefined;
      }
    | null
    | undefined;
};
...
export type LoginMutation = {
  ...
  login?:
    | {
        ...
        user?: { __typename?: 'User'; id: number; uuid: string; username: string; email: string } | null | undefined;
      }
    | null
    | undefined;
};
...
export type GetSharedListsQuery = {
  __typename?: 'Query';
  getSharedLists?: Array<string | null | undefined> | null | undefined;
};
...
export type MeQuery = {
  __typename?: 'Query';
  me?: { __typename?: 'User'; id: number; username: string; email: string; uuid: string } | null | undefined;
};
...
export const GoogleSignInDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'GoogleSignIn' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<GoogleSignInMutation, GoogleSignInMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'usernameOrEmail' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } },
        },
        {
          kind: 'VariableDefinition',
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'usernameOrEmail' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'password' },
...
export const ShareListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ShareList' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'listUuid' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } },
        },
        {
          kind: 'VariableDefinition',
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'listUuid' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'listUuid' } },
              },
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<ShareListMutation, ShareListMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'CanViewList' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<CanViewListQuery, CanViewListQueryVariables>;
export const GetSharedListsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetSharedLists' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'getSharedLists' } }],
      },
    },
  ],
} as unknown as DocumentNode<GetSharedListsQuery, GetSharedListsQueryVariables>;
